            ...
            <DropdownToggle className='ocuupancy__dropdown'>
                <div className='ocuupancy__field'>
                    ...
                    <div className='ocuupancy__controll-wrap'>
                        <span className='ocuupancy__controll' onClick={decreaseAdultsQuantity}>-</span>
                        <span className='ocuupancy__controll' onClick={increaseAdultsQuantity}>+</span>
                    </div>
                </div>
                <div className='ocuupancy__field'>
                    Kinderen
                    <div className='ocuupancy__controll-wrap'>
                        <span className='ocuupancy__controll' onClick={decreaseChildrenQuantity}>-</span>
                        <span className='ocuupancy__controll' onClick={increaseChildrenQuantity}>+</span>
                    </div>
                </div>
            </DropdownToggle>
        </div>
